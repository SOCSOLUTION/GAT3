                  ...
                  <div className="row g-5">
                    <div className="col-12 col-lg-8">
                      ...
                      <div className="card shadow-sm mt-3">
                        <div className="card-body px-4"><a className="d-block fz-18 hover-primary" >How do I
                      ...
                      <div className="card shadow-sm mt-3">
                        <div className="card-body px-4"><a className="d-block fz-18 hover-primary" >Where can I
                            find NFT sales?</a></div>
                      </div>
                      <div className="card shadow-sm mt-3">
                        <div className="card-body px-4"><a className="d-block fz-18 hover-primary" >How can I
                    ...
                    <div className="col-12 col-lg-4">
                      <div className="card bg-gray border-0 mt-2">
                        <div className="card-body p-4">
                          ...
                          <div className="border-top mb-3" /><a className="d-block fz-16 hover-primary mt-3" >How do I create an account?</a><a className="d-block fz-16 hover-primary mt-3" >How do I sell an NFT?</a><a className="d-block fz-16 hover-primary mt-3" >How do I create an NFT?</a><a className="d-block fz-16 hover-primary mt-3" >Where can I find NFT sales?</a><a className="d-block fz-16 hover-primary mt-3" >How can I stay safe and protect my NFTs?</a>
                        </div>
                      </div>
                    </div>
                  </div>
