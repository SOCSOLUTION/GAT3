                ...
                <div className="overflowY-scroll">
                  ...
                  <div className="mt-auto">
                    ...
                    <div className="copywrite-text mt-4">
                      <p className="mb-0 fz-14">2022 © All rights reserved by <a className="fz-14"  target="_blank">Designing World</a></p>
                    </div>
                  </div>
                </div>
              </div> */}
                  ...
                  <div className="row g-4">
                        ...
                        <div className="col-12">
                          <div className="card dashboard-hero-card p-2 border-0 bg-img shadow-sm" style={{backgroundImage: 'url("img/bg-img/44.jpg")'}}>
                            <div className="card-body p-4">
                              ...
                              <div className="button-groups"><a className="btn btn-sm btn-warning rounded-pill me-3">Discover</a><Link className="btn btn-sm btn-dark rounded-pill" to="/create-nft">Create</Link></div>
                            </div>
                          </div>
                        </div>
                        {/* Statistic Card */}
                        ...
                        <div className="card-body p-4">
                          <div className="d-flex flex-wrap align-items-center justify-content-between mb-3">
                            ...
                            <ul className="nav nav-tabs border-0 mb-2" id="funtoTab" role="tablist">
                              <li className="nav-item"><a className="rounded-pill btn btn-sm btn-primary me-1 active" id="tab--1" data-bs-toggle="tab"  role="tab" aria-controls="tab1" aria-selected="true">Today</a></li>
                              <li className="nav-item"><a className="rounded-pill btn btn-sm btn-primary me-1" id="tab--2" data-bs-toggle="tab"  role="tab" aria-controls="tab2" aria-selected="false">7 days</a></li>
                              <li className="nav-item"><a className="rounded-pill btn btn-sm btn-primary" id="tab--3" data-bs-toggle="tab"  role="tab" aria-controls="tab3" aria-selected="false">30 days</a></li>
                            </ul>
                          </div>
                                  ...
                                  <div className="row gx-2 align-items-center mt-2">
                                    <div className="col-8">
                                      <div className="name-info d-flex align-items-center">
                                        ...
                                        <div className="name-author"><Link className="name d-block hover-primary fw-bold text-truncate" to="/art_details" data-bs-toggle="tooltip" data-bs-placement="top" title="Fancy Car">Fancy Car</Link><Link className="author d-block fz-12 hover-primary text-truncate" to="/artist_details">@fancy_car</Link></div>
                                      </div>
                                    </div>
                                    <div className="col-4">
                                    ...
                                    <div className="col-12"><a className="btn btn-primary rounded-pill btn-sm mt-3 w-100" >Place Bid</a></div>
                                  </div>
                                </div>
                              </div>
                            </div>
                                  ...
                                  <div className="row gx-2 align-items-center mt-2">
                                    <div className="col-8">
                                      <div className="name-info d-flex align-items-center">
                                        ...
                                        <div className="name-author"><Link className="name d-block hover-primary fw-bold text-truncate" to="/art_details" data-bs-toggle="tooltip" data-bs-placement="top" title="Animal Playing with Guiter">Animal Playing with Guiter</Link><Link className="author d-block fz-12 hover-primary text-truncate" to="/artist_details">@creative_world</Link></div>
                                      </div>
                                    </div>
                                    <div className="col-4">
                                      <div className="price text-end"><span className="fz-12 d-block">Current Bid</span>
                                  ...
                                  <div className="row gx-2 align-items-center mt-2">
                                    <div className="col-8">
                                      <div className="name-info d-flex align-items-center">
                                        ...
                                        <div className="name-author"><Link className="name d-block hover-primary fw-bold text-truncate" to="/art_details" data-bs-toggle="tooltip" data-bs-placement="top" title="Halloween #471">Halloween #471</Link><Link className="author d-block fz-12 hover-primary text-truncate" to="/artist_details">@fancy_car</Link></div>
                                      </div>
                                    </div>
                                    <div className="col-4">
                                      <div className="price text-end"><span className="fz-12 d-block">Current Bid</span>
                                    ...
                                    <div className="col-12"><a className="btn btn-primary rounded-pill btn-sm mt-3 w-100 disabled" >Place Bid</a></div>
                                  </div>
                                </div>
                              </div>
                            </div>
                                  ...
                                  <div className="row gx-2 align-items-center mt-2">
                                    <div className="col-8">
                                      <div className="name-info d-flex align-items-center">
                                        ...
                                        <div className="name-author"><Link className="name d-block hover-primary fw-bold text-truncate" to="/art_details" data-bs-toggle="tooltip" data-bs-placement="top" title="Vigor Dance">Vigor Dance</Link><Link className="author d-block fz-12 hover-primary text-truncate" to="/artist_details">@fancy_nft</Link></div>
                                      </div>
                                    </div>
                                    <div className="col-4">
                                      <div className="price text-end"><span className="fz-12 d-block">Current Bid</span>
                                    ...
                                    <div className="col-12"><a className="btn btn-warning rounded-pill btn-sm mt-3 w-100" >Place Bid</a></div>
                                  </div>
                                </div>
                              </div>
                            </div>
                      ...
                      <div className="card border-0 shadow-sm">
                        <div className="card-body p-4">
                          <div className="d-flex align-items-center justify-content-between mb-3">
                            <h5>Top NFTs</h5><a className="btn btn-primary btn-minimal" >View all NFTs</a>
                          </div>
                                ...
                                <div className="card-body">
                                  ...
                                  <div className="row gx-2 align-items-center mt-2">
                                    <div className="col-8">
                                      <div className="name-info d-flex align-items-center">
                                        <div className="author-img position-relative"><img className="shadow" src="img/bg-img/u1.jpg" alt="" /><i className="bi bi-check position-absolute bg-success" /></div>
                                        <div className="name-author"><Link className="name d-block hover-primary fw-bold text-truncate" to="/art_details" data-bs-toggle="tooltip" data-bs-placement="top" title="Cowboy Riding Bull Nature">Cowboy Riding Bull Nature</Link><Link className="author d-block fz-12 hover-primary text-truncate" to="/artist_details">@designing_world</Link></div>
                                      </div>
                                    </div>
                                    <div className="col-4">
                                      <div className="price text-end"><span className="fz-12 d-block">Current Bid</span>
                                  ...
                                  {/* Button */}
                                  <div className="row gx-2 align-items-center mt-3">
                                    <div className="col-6"><a className="btn btn-primary rounded-pill btn-sm" >Place Bid</a></div>
                                    <div className="col-6 text-end"><Link className="btn btn-minimal btn-sm hover-primary" to="/activity"> <i className="bi bi-activity me-1" />Activity</Link></div>
                                  </div>
                                </div>
                              </div>
                            </div>
                                ...
                                <div className="card-body">
                                  ...
                                  <div className="row gx-2 align-items-center mt-2">
                                    <div className="col-8">
                                      <div className="name-info d-flex align-items-center">
                                        <div className="author-img position-relative"><img className="shadow" src="img/bg-img/u2.jpg" alt="" /><i className="bi bi-check position-absolute bg-success" /></div>
                                        <div className="name-author"><Link className="name d-block hover-primary fw-bold text-truncate" to="/art_details" data-bs-toggle="tooltip" data-bs-placement="top" title="Chicken Wearing Santa Hats">Chicken Wearing Santa Hats</Link><Link className="author d-block fz-12 hover-primary text-truncate" to="/artist_details">@style_wear</Link></div>
                                      </div>
                                    </div>
                                    <div className="col-4">
                                      <div className="price text-end"><span className="fz-12 d-block">Current Bid</span>
                                ...
                                <div className="card-body">
                                  ...
                                  <div className="row gx-2 align-items-center mt-2">
                                    <div className="col-8">
                                      <div className="name-info d-flex align-items-center">
                                        <div className="author-img position-relative"><img className="shadow" src="img/bg-img/u3.jpg" alt="" /><i className="bi bi-check position-absolute bg-success" /></div>
                                        <div className="name-author"><Link className="name d-block hover-primary fw-bold text-truncate" to="/art_details" data-bs-toggle="tooltip" data-bs-placement="top" title="Diamond Animals">Diamond Animals</Link><Link className="author d-block fz-12 hover-primary text-truncate" to="/artist_details">@affan</Link></div>
                                      </div>
                                    </div>
                                    <div className="col-4">
                                      <div className="price text-end"><span className="fz-12 d-block">Current Bid</span>
                    ...
                    <div className="col-12 col-md-6 col-xl-4">
                      <div className="card border-0 shadow-sm">
                        <div className="card-body p-4">
                          <div className="d-flex align-items-center justify-content-between mb-3">
                            <h5>Top Seller</h5><a className="btn btn-primary btn-minimal" >View all</a>
                          </div>
                          {/* Single Card */}
                          <div className="nft-card card seller-card shadow-sm mb-4">
                            <div className="card-body">
                              <div className="row align-items-center g-3">
                                ...
                                <div className="col-8">
                                  <div className="name-author"><a className="name d-block hover-primary fw-bold text-truncate" >Designing World<i className="bi bi-patch-check-fill ms-2 text-success" data-bs-toggle="tooltip" data-bs-placement="top" title="Verified" /></a><a className="author d-block fz-14 hover-primary text-truncate" >@designing_world</a>
                          ...
                          <div className="nft-card card seller-card shadow-sm">
                            <div className="card-body">
                              <div className="row align-items-center g-3">
                                ...
                                <div className="col-8">
                                  <div className="name-author"><a className="name d-block hover-primary fw-bold text-truncate" >Art World<i className="bi bi-patch-check-fill ms-2 text-success" data-bs-toggle="tooltip" data-bs-placement="top" title="Verified" /></a><a className="author d-block fz-14 hover-primary text-truncate" >@art_world</a>
                                    <div className="price-bid d-flex align-items-center mt-3">
                        ...
                        <div className="card-body p-4">
                          ...
                          <div className="top-author-slide-wrap">
                            <div className="top-authors-slide">
                              <div><a ><img src="img/bg-img/u1.jpg" alt="" /></a></div>
                              <div><a ><img src="img/bg-img/u2.jpg" alt="" /></a></div>
                              <div><a ><img src="img/bg-img/u3.jpg" alt="" /></a></div>
                              <div><a ><img src="img/bg-img/u4.jpg" alt="" /></a></div>
                              <div><a ><img src="img/bg-img/u1.jpg" alt="" /></a></div>
                              <div><a ><img src="img/bg-img/u2.jpg" alt="" /></a></div>
                              <div><a ><img src="img/bg-img/u3.jpg" alt="" /></a></div>
                              <div><a ><img src="img/bg-img/u4.jpg" alt="" /></a></div>
