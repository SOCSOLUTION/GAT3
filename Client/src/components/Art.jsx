                  ...
                  <div className="row g-4 align-items-end">
                    <div className="col-12 col-sm-6 col-lg-3">
                      ...
                      <select className=" filter-select bg-gray w-100">
                        <option className='opt' selected value="all">All</option>
                        <option className='opt' selected value="buy-now">Buy Now</option>
                        <option className='opt' value="on-auction">On Auction</option>
                    ...
                    <div className="col-12 col-sm-6 col-lg-3">
                      ...
                      <select className="filter-select2 bg-gray w-100 ">
                        <option className='opt' selected value={1}>3D Art</option>
                        <option className='opt' value={2}>Surreal</option>
                        <option className='opt' value={3}>Illustration</option>
                        <option className='opt' value={4}>Painting</option>
                        <option className='opt' value={5}>Photography</option>
                        <option className='opt' value={6}>AI</option>
                        <option className='opt' value={7}>Pixel Art</option>
                        <option className='opt' value={8}>Psychedelic</option>
                        <option className='opt' value={9}>Animation</option>
                        <option className='opt' value={10}>Abstract</option>
                        <option className='opt' value={11}>Realistic</option>
                        <option className='opt' value={12}>Multidisciplinary</option>
                    ...
                    <div className="col-12 col-sm-6 col-lg-3">
                      <h5>Sort By</h5>
                      <select className="filter-select bg-gray w-100">
                        <option className='opt' selected value={1}>Recently Added</option>
                        <option className='opt' value={2}>Recently Sold</option>
                        <option className='opt' value={3}>Ending Soon</option>
                      </select>
                    </div>
                    ...
                    <div className="col-12 col-sm-6 col-lg-3">
                      ...
                      <select className="filter-select bg-gray w-100" value={currency} onChange={handleChange}>
                        <option className='opt' selected value={"ETH"} >ETH</option>
                        <option className='opt' value={"EUR"} >EUR</option>
                    ...
                    <div className="col-12 col-sm-6 col-lg-4 col-xl-3">
                      <div className="nft-card card shadow-sm">
                        <div className="card-body">
                          ...
                          <div className="row gx-2 align-items-center mt-2">
                            <div className="col-8">
                              <div className="name-info d-flex align-items-center">
                                ...
                                <div className="name-author"><a className="name d-block hover-primary fw-bold text-truncate"  data-bs-toggle="tooltip" data-bs-placement="top" title="Monkey Arts #114">Monkey Arts #114</a><a className="author d-block fz-12 hover-primary text-truncate" >@nft_fun</a></div>
                              </div>
                            </div>
                            <div className="col-4">
                          ...
                          {/* Button */}
                          <div className="row gx-2 align-items-center mt-3">
                            <div className="col-6"><Link to="/art_details" className="btn btn-primary btn-sm rounded-pill">Place bid</Link>
                            </div>
                    ...
                    <div className="col-12 col-sm-6 col-lg-4 col-xl-3">
                      <div className="nft-card card shadow-sm">
                        <div className="card-body">
                          ...
                          <div className="row gx-2 align-items-center mt-2">
                            <div className="col-8">
                              <div className="name-info d-flex align-items-center">
                                ...
                                <div className="name-author"><Link className="name d-block hover-primary fw-bold text-truncate" to="/art_details" data-bs-toggle="tooltip" data-bs-placement="top" title="Two Monkey's Fun">Two Monkey's Fun</Link><Link className="author d-block fz-12 hover-primary text-truncate" to="/artist_details">@creative_art</Link>
                                </div>
                              </div>
                            </div>
                            <div className="col-4">
                          ...
                          {/* Button */}
                          <div className="row gx-2 align-items-center mt-3">
                            <div className="col-6"><Link className="btn btn-primary btn-sm rounded-pill" to="/art">Place bid</Link>
                            </div>
                    ...
                    <div className="col-12 col-sm-6 col-lg-4 col-xl-3">
                      <div className="nft-card card shadow-sm">
                        <div className="card-body">
                          ...
                          <div className="row gx-2 align-items-center mt-2">
                            <div className="col-8">
                              <div className="name-info d-flex align-items-center">
                                ...
                                <div className="name-author"><a className="name d-block hover-primary fw-bold text-truncate"  data-bs-toggle="tooltip" data-bs-placement="top" title="Kings with Bitcoin">Kings with Bitcoin</a><a className="author d-block fz-12 hover-primary text-truncate" >@designing_world</a>
                                </div>
                              </div>
                            </div>
                            <div className="col-4">
                          ...
                          {/* Button */}
                          <div className="row gx-2 align-items-center mt-3">
                            <div className="col-6"><a className="btn btn-primary btn-sm rounded-pill" >Place bid</a>
                            </div>
                            <div className="col-6 text-end"><a className="btn btn-minimal btn-sm hover-primary" > <i className="bi bi-activity me-1" />Activity</a></div>
                          </div>
                        </div>
                          ...
                          <div className="row gx-2 align-items-center mt-2">
                            <div className="col-8">
                              <div className="name-info d-flex align-items-center">
                                ...
                                <div className="name-author"><a className="name d-block hover-primary fw-bold text-truncate"  data-bs-toggle="tooltip" data-bs-placement="top" title="Pixel Plane">Pixel Plane</a><a className="author d-block fz-12 hover-primary text-truncate" >@nft_fun</a></div>
                              </div>
                            </div>
                            <div className="col-4">
                              <div className="price text-end"><span className="fz-12 d-block">Current Bid</span>
                        ...
                        <div className="card-body">
                          ...
                          <div className="row gx-2 align-items-center mt-2">
                            <div className="col-8">
                              <div className="name-info d-flex align-items-center">
                                <div className="author-img position-relative"><img className="shadow" src="img/bg-img/u1.jpg" alt="" /><i className="bi bi-check position-absolute bg-success" /></div>
                                <div className="name-author"><a className="name d-block hover-primary fw-bold text-truncate"  data-bs-toggle="tooltip" data-bs-placement="top" title="Macaw Bird">Macaw Bird</a><a className="author d-block fz-12 hover-primary text-truncate" >@creative_art</a></div>
                              </div>
                            </div>
                            <div className="col-4">
                              <div className="price text-end"><span className="fz-12 d-block">Current Bid</span>
                        ...
                        <div className="card-body">
                          ...
                          <div className="row gx-2 align-items-center mt-2">
                            <div className="col-8">
                              <div className="name-info d-flex align-items-center">
                                <div className="author-img position-relative"><img className="shadow" src="img/bg-img/u2.jpg" alt="" /><i className="bi bi-check position-absolute bg-success" /></div>
                                <div className="name-author"><a className="name d-block hover-primary fw-bold text-truncate"  data-bs-toggle="tooltip" data-bs-placement="top" title="Sculpture Human Face">Sculpture Human Face</a><a className="author d-block fz-12 hover-primary text-truncate" >@designing_world</a>
                                </div>
                              </div>
                            </div>
                            <div className="col-4">
                        ...
                        <div className="card-body">
                          ...
                          <div className="row gx-2 align-items-center mt-2">
                            <div className="col-8">
                              <div className="name-info d-flex align-items-center">
                                <div className="author-img position-relative"><img className="shadow" src="img/bg-img/u2.jpg" alt="" /><i className="bi bi-check position-absolute bg-success" /></div>
                                <div className="name-author"><a className="name d-block hover-primary fw-bold text-truncate"  data-bs-toggle="tooltip" data-bs-placement="top" title="Two Monkey's Fun">Two Monkey's Fun</a><a className="author d-block fz-12 hover-primary text-truncate" >@creative_art</a>
                                </div>
                              </div>
                            </div>
                            <div className="col-4">
