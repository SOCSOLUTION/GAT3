                    ...
                    <div className="col-12 col-md-9 col-lg-6">
                      <div className="item-details-content mt-5 mt-lg-0">
                        ...
                        <div className="d-flex align-items-center mb-4">
                          ...
                          <div className="name-author"><span className="d-block fz-14">Created by</span><a className="author d-block fz-16 hover-primary text-truncate" >@creative_world</a>
                          </div>
                        </div>
                        ...
                        <div className="row align-items-end">
                          ...
                          <div className="col-6 col-sm-4 col-lg-5"><a className="btn btn-primary rounded-pill w-100" ><img className="me-1" src="img/core-img/fire.png" alt="" />Place a bid</a></div>
                        </div>
                          ...
                          <div className="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab--2">
                            <div className="table-responsive border shadow-sm activity-table bg-white">
                              <table className="table mb-0">
                                <tbody>
                                  <tr>
                                    <th scope="row"><a className="btn btn-minimal text-dark hover-primary" >
                    ...
                    <div>
                      ...
                      <div className="nft-card card shadow-sm">
                        <div className="card-body">
                          <div className="img-wrap"><img src="img/bg-img/13.jpg" alt="" />
                            ...
                            <div className="dropdown">
                              ...
                              <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="dttd987">
                                <li><a className="dropdown-item" ><i className="me-1 bi bi-share" />Share</a>
                                </li>
                                <li><a className="dropdown-item" ><i className="me-1 bi bi-bookmark" />Bookmark</a></li>
                                <li><a className="dropdown-item" ><i className="me-1 bi bi-flag" />Report</a>
                                </li>
                              </ul>
                            </div>
                          </div>
                          ...
                          {/* Button */}
                          <div className="row gx-2 align-items-center mt-3">
                            <div className="col-6"><a className="btn btn-primary btn-sm rounded-pill" >Place
                                bid</a></div>
